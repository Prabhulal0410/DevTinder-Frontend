    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0C] px-4 py-12 sm:px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-[#2A2B30] bg-[#17181C] p-6 sm:p-8">
          ...
          <p className="mb-6 text-sm text-[#8B8D98]">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <label
                htmlFor="emailId"
                className="mb-1.5 block text-sm font-medium text-[#EDEDEF]"
              >
                Email
              </label>
              <input
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-sm font-medium text-[#EDEDEF]"
                >
                  Password
                </label>
                <a
                  href="/forgot-password"
                  className="text-xs font-medium text-[#5B6EF5] hover:underline"
                >
                  Forgot password?
                </a>
              </div>
              ...
              {errors.password && (
                <p
                  id="password-error"
                  className="mt-1.5 text-xs text-[#F45B69]"
                >
                  {errors.password}
                </p>
              )}
        ...
        <p className="mt-6 text-center text-sm text-[#8B8D98]">
          ...
          <a
            href="/signup"
            className="font-medium text-[#5B6EF5] hover:underline"
          >
            Sign up
          </a>
        </p>
